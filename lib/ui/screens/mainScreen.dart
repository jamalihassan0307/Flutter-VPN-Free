...
class _MainScreenState extends State<MainScreen> {
  ...
  void initVpn() async {
    _listVpn.add(VpnConfig(config: await rootBundle.loadString("assets/vpn/United States.ovpn"), name: "Japan"));
    _listVpn.add(VpnConfig(config: await rootBundle.loadString("assets/vpn/Taiwan.ovpn"), name: "United State"));
    if (mounted)
      setState(() {
