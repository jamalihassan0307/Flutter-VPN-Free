...
*/
    ...
    static void updateStateString(String state, String msg) {
        ...
        String stateMsg = msg;
        if (rid != -1) {
            stateMsg = String.format("%s: %s", getEmbeddedString(rid), msg);
        }
        logInfo(stateMsg);
    }
    ...
    public static void logInfo(String msg) {
        newLogItem(new LogItem(LogLevel.INFO, msg));
    }

    public static void logDebug(String msg) {
        newLogItem(new LogItem(LogLevel.DEBUG, msg));
    }
    ...
    private static String getEmbeddedString(int resid) {
        return resid + "";  // For now just return the string representation of the resource id
    }
}
